...
data2 = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/test/li9_testData.txt", sep=" ", header=None)
...
data3 = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/test/n17_testData.txt", sep=" ", header=None)
...
data5 = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/test/world_testData.txt", sep=" ", header=None)
...
df5['label'] = 0
datat = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/test/tornessfull_testData.txt", sep=" ", header=None)
...
#datah = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/test/heyshamfull_testData.txt", sep=" ", header=None)
...
data6 = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/test/fn_testData.txt", sep=" ", header=None)
...
data7 = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/test/geo_testData.txt", sep=" ", header=None)
...
data8 = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/test/heysham2_testData.txt", sep=" ", header=None)
...
plt.savefig('/mnt/c/Users/Niamh/Documents/SummerJob/figures/22m_gdwbls/h2_uncal/cm_test22wbls.png')
plt.show()
...
plt.savefig('/mnt/c/Users/Niamh/Documents/SummerJob/figures/22m_gdwbls/h2_uncal/roc_test22wbls.png')
plt.show()

test_neu.to_csv('/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/h2_uncal_clf/fn_finder/22wbls_clftestdata.csv')
filename = '/mnt/c/Users/Niamh/Documents/SummerJob/data/22m_gdwbls/h2_uncal_clf/fn_finder/fnfinder_22wbls.sav'
