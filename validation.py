...
#load data
data2 = pd.read_csv('/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/hf_uncal_clf/hf_uncal_clf/li9_clfData16.txt', sep= " ", header=None)
...
data3 = pd.read_csv('/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/hf_uncal_clf/hf_uncal_clf/n17_clfData16.txt', sep= " ", header=None)
...
data5 = pd.read_csv('/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/hf_uncal_clf/hf_uncal_clf/world_clfData16.txt', sep= " ", header=None)
...
datat = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/hf_uncal_clf/hf_uncal_clf/tornessfull_clfData16.txt", sep=" ", header=None)
...
data6 = pd.read_csv('/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/hf_uncal_clf/hf_uncal_clf/fn_clfData16.txt', sep= " ", header=None)
...
data7 = pd.read_csv('/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/hf_uncal_clf/hf_uncal_clf/geo_clfData16.txt', sep= " ", header=None)
...
#data8 = pd.read_csv("/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/t+h_uncal_clf/t+h_uncal_clf/heysham2_clfData16.txt", sep=" ", header=None)
...
disp.figure_.suptitle('Fast Neutron Finder, Heysham full Signal (final validation, 16m_gdwbls)')
plt.savefig('/mnt/c/Users/Niamh/Documents/SummerJob/figures/16m_gdwbls/hf_uncal/cm_clf16wbls.png')
plt.show()
...
plt.legend(loc='best')
plt.title('Fast Neutron finder, Heysham full signal (final validation, 16m_gdwbls)')
plt.savefig('/mnt/c/Users/Niamh/Documents/SummerJob/figures/16m_gdwbls/hf_uncal/roc_clf16wbls.png')
plt.show()
...
print(X)
X.to_csv('/mnt/c/Users/Niamh/Documents/SummerJob/data/16m_gdwbls/hf_uncal_clf/16wbls_clfclfdata.csv')
